...
{
public:
	Material(XMFLOAT3 colorTint, XMFLOAT2 uvScale, XMFLOAT2 uvOffset, float roughness, bool isReflective, Microsoft::WRL::ComPtr<ID3D12PipelineState> pipelineState);
